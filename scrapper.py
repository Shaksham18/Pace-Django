    ...
    for row in tbody:
        ...
        try:
            temp_data = {
                ...
                '_1h': td_data[2].getText(),
                '_24h': td_data[3].getText(),
                '_7d': td_data[4].getText(),
...
def update_coin_data(driver):
    _url = 'http://localhost:5000/coin/'
    payload = parse_table_content(get_table_content(driver))
